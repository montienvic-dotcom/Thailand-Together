...
class PlatformSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Applications (15 apps — all enabled in Pattaya) ──
        $apps = [
            ...
            ['name' => 'Project Management', 'slug' => 'project-management', 'code' => 'PROJECT_MGMT', 'type' => 'web', 'source' => 'internal', 'icon' => 'clipboard-document-check', 'color' => '#7C3AED', 'sort_order' => 14, 'description' => 'End-to-end project management — planning, task tracking, Gantt charts, resource allocation, budget control, risk management, and executive reporting'],
            ['name' => 'Data Exchange', 'slug' => 'data-exchange', 'code' => 'DATA_EXCHANGE', 'type' => 'web', 'source' => 'internal', 'icon' => 'circle-stack', 'color' => '#059669', 'sort_order' => 15, 'description' => 'Central data exchange hub — data catalog, quality management, security governance, high-value datasets, sandbox analytics, data requests, and usage monitoring'],
        ];
