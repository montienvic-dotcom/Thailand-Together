-- ============================================================
-- Thailand Together — DATABASE VIEWS (9 views)
-- For: Journey & Merchant admin/API system
-- Database: u504097778_platform
-- Generated: 2026-03-09
-- ============================================================
-- Order matters: dependent views must be created after their source views
-- Dependencies:
--   vw_merchant_search_user      → vw_merchant_search_public
--   vw_merchant_search_blob_user → vw_merchant_search_blob_public
--   vw_api_journey_onecall_with_merchants_stats_final → vw_journey_place_merchant_json, vw_journey_merchant_stats
--   vw_api_journey_onecall_with_merchants_user → vw_journey_merchant_json_user
-- ============================================================
